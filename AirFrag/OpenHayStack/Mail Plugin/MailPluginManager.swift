...
struct MailPluginManager {
    ...
    let localPluginURL = FileManager.default.homeDirectoryForCurrentUser.appendingPathComponent("/Library/Mail/Bundles").appendingPathComponent(mailBundleName + ".mailbundle")
