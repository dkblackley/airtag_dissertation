...
struct MainView {
    ...
    internal init(controller: AccessoryController) {
        ...
        func alert(for alertType: AlertType) -> Alert {
            ...
            case .activatePlugin:
                ...
                return Alert(
                    ...
                    primaryButton: .default(Text("Okay"), action: { print("INSTALL PLUGIN") }),
